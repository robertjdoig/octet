...
namespace octet { namespace scene {
  ...
  public:
    ...
    mesh_instance *add_shape(mat4t_in mat, mesh *msh, material *mtl, btVector3 force, btVector3 relPos, bool is_dynamic=false, float mass=1, collison_shape_t *shape=NULL) {
